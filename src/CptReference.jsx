...
const CPT_DB = [
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    bundling: "Bundled with 92250 (fundus photos) under most MACs — can only unbundle with documented medical necessity and different diagnoses for each test. Mutually exclusive with 92133 (optic nerve OCT) and 92137 (OCT-A) same patient same day — choose ONE of 92133/92134/92137.",
  ...
  },
  {
    ...
    bundling: "May be mutually exclusive with 92134 (retina OCT) same eye same day under some payers. Mutually exclusive with 92137 (OCT-A). Check NCCI and local LCD.",
  ...
  },
  {
    ...
    bundling: "MUTUALLY EXCLUSIVE with 92134 (retinal OCT) and 92133 (optic nerve OCT) — cannot bill any combination of 92133/92134/92137 same patient same day. Choose ONE. NCCI edits with FA (92235), ICG (92240), FA/ICG (92242) were DELETED retroactive to Oct 1, 2025 — OCT-A + FA/ICG is now billable same day without modifier. NCCI edits with eye visit codes (92002, 92004, 92012, 92014) are RETAINED with modifier indicator 1 — can bypass with -59/XE/XS/XU when medically appropriate. NO NCCI edit with E/M codes (99213-99215) — no modifier needed alongside 99214-25 on injection days.",
    modifiers: "-26 if professional only (facility setting). -TC for technical only. -59/XE/XS/XU ONLY if billing same day as eye visit code (920xx) — not needed with E/M codes (992xx).",
    tips: "Reimburses ~$56.93 (2026 Medicare) vs ~$31.38 for 92134 — about 45% more. On injection days: bill 99214-25 + 67028 + J-code + 92137 (no extra modifier on OCT-A). On non-injection days using E/M: same, 92137 rides alongside E/M. On non-injection days using eye visit code: may need -59 on 92137 to bypass retained NCCI edit. NEVER bill 92134 + 92137 same day — the OCT-A code INCLUDES the structural OCT. Bill bilateral with one unit. ASRS is still advocating for removal of eye visit code edits.",
  },
  {
    code: "92235",
