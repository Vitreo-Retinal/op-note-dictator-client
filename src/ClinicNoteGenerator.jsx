      ...
      <div style={{ padding: "20px 24px", maxWidth: 800, margin: "0 auto" }}>
        ...
        {tab === "codes" && (() => {
          const ICD10_DB = [
            ...
            { cat: "Anterior Segment", code: "H40.13x", desc: "pigmentary glaucoma" },
            ...
            { cat: "Artery Occlusion", code: "H34.21x", desc: "Partial retinal artery occlusion / Hollenhorst plaque" },
            ...
            { cat: "Cornea & External", code: "H16.03x", desc: "Corneal abscess" },
            { cat: "Cornea & External", code: "H16.0x", desc: "Corneal ulcer" },
            { cat: "Cornea & External", code: "H16.11x", desc: "HSV keratitis (code B00.52 too)" },
            ...
            { cat: "Diabetic", code: "E10.311x", desc: "T1DM Unspecified DR with DME (+ laterality)" },
            { cat: "Diabetic", code: "E10.319x", desc: "T1DM Unspecified DR without DME" },
            { cat: "Diabetic", code: "E10.321x", desc: "T1DM Mild NPDR with DME" },
            { cat: "Diabetic", code: "E10.329x", desc: "T1DM Mild NPDR without DME" },
            { cat: "Diabetic", code: "E10.331x", desc: "T1DM Moderate NPDR with DME" },
            { cat: "Diabetic", code: "E10.339x", desc: "T1DM Moderate NPDR without DME" },
            { cat: "Diabetic", code: "E10.341x", desc: "T1DM Severe NPDR with DME" },
            { cat: "Diabetic", code: "E10.349x", desc: "T1DM Severe NPDR without DME" },
            ...
            { cat: "Diabetic", code: "E11.311x", desc: "T2DM Unspecified DR with DME (+ laterality)" },
            { cat: "Diabetic", code: "E11.319x", desc: "T2DM Unspecified DR without DME" },
            { cat: "Diabetic", code: "E11.321x", desc: "T2DM Mild NPDR with DME" },
            { cat: "Diabetic", code: "E11.329x", desc: "T2DM Mild NPDR without DME" },
            { cat: "Diabetic", code: "E11.331x", desc: "T2DM Moderate NPDR with DME" },
            { cat: "Diabetic", code: "E11.339x", desc: "T2DM Moderate NPDR without DME" },
            { cat: "Diabetic", code: "E11.341x", desc: "T2DM Severe NPDR with DME" },
            { cat: "Diabetic", code: "E11.349x", desc: "T2DM Severe NPDR without DME" },
            ...
            { cat: "Diabetic", code: "H43.1x", desc: "VH) → only for NON-diabetic VH (RVO" },
            ...
            { cat: "Glaucoma", code: "H40.111_", desc: "Primary open-angle glaucoma (POAG) / chronic simple (OD/OS/OU + staging) (OD)" },
            { cat: "Glaucoma", code: "H40.112_", desc: "Primary open-angle glaucoma (POAG) / chronic simple (OD/OS/OU + staging) (OS)" },
            { cat: "Glaucoma", code: "H40.113_", desc: "Primary open-angle glaucoma (POAG) / chronic simple (OD/OS/OU + staging) (OU)" },
            ...
            { cat: "Glaucoma", code: "H40.3x", desc: "H40.6x (code underlying condition first + staging in 7th):**" },
            ...
            { cat: "Glaucoma", code: "H40.6x", desc: "code underlying condition first + staging in 7th):**" },
            ...
            { cat: "Macular", code: "H35.07x", desc: "Macular telangiectasia (MacTel)" },
            { cat: "Macular", code: "H35.09x", desc: "Other intraretinal microvascular abnormalities" },
            ...
            { cat: "Other Retinal", code: "H35.04x", desc: "Changes in retinal vascular appearance" },
            { cat: "Other Retinal", code: "H35.06x", desc: "Retinal vasculitis" },
            ...
            { cat: "RD & Breaks", code: "E11.353x", desc: "TRD involving or not involving macula" },
            ...
            { cat: "RD & Breaks", code: "H33.3x", desc: "retinal breaks" },
            ...
            { cat: "Trauma", code: "S05.8x", desc: "Other injuries of eye/orbit" },
            ...
            { cat: "Tumors", code: "C69.8x", desc: "Ocular lymphoma / vitreoretinal lymphoma" },
            { cat: "Tumors", code: "C79.81", desc: "Choroidal metastasis (code primary malignancy too)" },
            { cat: "Tumors", code: "C83.3x", desc: "DLBCL (code subtype if known alongside C69)" },
            { cat: "Tumors", code: "C85.9x", desc: "NHL unspecified (if no subtype given)" },
            ...
            { cat: "Tumors", code: "D31.6x", desc: "Astrocytic hamartoma / astrocytoma" },
            ...
            { cat: "Uveitis", code: "H30.81x", desc: "Harada disease / VKH" },
            { cat: "Uveitis", code: "H44.13x", desc: "systemic exception" },
            ...
            { cat: "Vitreous", code: "H43.11", desc: "Vitreous hemorrhage— NON-DIABETIC only (OD)" },
            { cat: "Vitreous", code: "H43.12", desc: "Vitreous hemorrhage— NON-DIABETIC only (OS)" },
            { cat: "Vitreous", code: "H43.13", desc: "Vitreous hemorrhage— NON-DIABETIC only (OU)" },
            ...
            { cat: "Z-Codes & Status", code: "H54.0x", desc: "Low vision / blindness classification" },
