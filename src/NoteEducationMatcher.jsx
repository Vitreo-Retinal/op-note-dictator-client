...
export function detectDropsFromPlan(noteText) {
  ...
  const drugPatterns = [
    ...
    { regex: /(latanoprost|xalatan)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Latanoprost" },
    { regex: /(?:ctn|start|begin|continue|resume|add)\s+(timolol|timoptic)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Timolol" },
    { regex: /(timolol|timoptic)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Timolol" },
    { regex: /(?:ctn|start|begin|continue|resume|add)\s+(brimonidine|alphagan)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Brimonidine" },
    { regex: /(brimonidine|alphagan)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Brimonidine" },
    { regex: /(?:ctn|start|begin|continue|resume|add)\s+(dorzolamide|trusopt)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Dorzolamide" },
    ...
    { regex: /(durezol)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?\s*(.*?)(?:\n|$)/gi, name: "Durezol" },
    { regex: /(?:ctn|start|begin|continue|resume|add)\s+(ketorolac|acular)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Ketorolac" },
    { regex: /(ketorolac|acular)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Ketorolac" },
    { regex: /(?:ctn|start|begin|continue|resume|add)\s+(maxitrol)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?\s*(.*?)(?:\n|$)/gi, name: "Maxitrol" },
    { regex: /(maxitrol)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?\s*(.*?)(?:\n|$)/gi, name: "Maxitrol" },
    { regex: /(?:ctn|start|begin|continue|resume|add)\s+(rhopressa|netarsudil)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Rhopressa" },
    { regex: /(rhopressa|netarsudil)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Rhopressa" },
    { regex: /(?:ctn|start|begin|continue|resume|add)\s+(rocklatan)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Rocklatan" },
    { regex: /(rocklatan)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Rocklatan" },
    { regex: /(?:ctn|start|begin|continue|resume|add)\s+(combigan)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Combigan" },
    { regex: /(combigan)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Combigan" },
    { regex: /(?:ctn|start|begin|continue|resume|add)\s+(pilocarpine)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Pilocarpine" },
    { regex: /(pilocarpine)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Pilocarpine" },
    { regex: /(?:ctn|start|begin|continue|resume|add)\s+(atropine)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Atropine" },
    { regex: /(atropine)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Atropine" },
    { regex: /(?:ctn|start|begin|continue|resume|add)\s+(vyzulta)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Vyzulta" },
    { regex: /(vyzulta)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Vyzulta" },
    { regex: /(?:ctn|start|begin|continue|resume|add)\s+(lumigan|bimatoprost)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Lumigan" },
    { regex: /(lumigan|bimatoprost)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Lumigan" },
    { regex: /(?:ctn|start|begin|continue|resume|add)\s+(travatan|travoprost)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Travatan" },
    { regex: /(travatan|travoprost)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Travatan" },
    { regex: /(?:ctn|start|begin|continue|resume|add)\s+(lotemax|loteprednol)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?\s*(.*?)(?:\n|$)/gi, name: "Lotemax" },
    { regex: /(lotemax|loteprednol)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?\s*(.*?)(?:\n|$)/gi, name: "Lotemax" },
    { regex: /(?:ctn|start|begin|continue|resume|add)\s+(erythromycin)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Erythromycin" },
    { regex: /(erythromycin)\s+(qid|tid|bid|qd|qhs)\s*(od|os|ou)?/gi, name: "Erythromycin" },
  ];
